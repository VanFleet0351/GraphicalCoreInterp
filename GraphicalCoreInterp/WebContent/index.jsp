...
<body>
	...
	<Section>
		...
		<p>Enter your program in the input text area and data into the
			data text area and click "Run" to run the programs and get its
			output. A sample program and data may be selected from the drop down
			tab to run as well.</p>
	</section>
	...
	<form method="post" action="Interpreter">
		<section>
			<label for="prog"><b>Input:</b></label> <br>
			<%
			...
			<br> <br> <label for="data"><b>Data:</b></label> <br>
			<%
